...
define( 'WP_CONTENT_URL', 'http://' . $_SERVER['HTTP_HOST'] . '/edwp-workshop/con-duplicator/assets' );


// Mover el directorio plugin
define( 'WP_PLUGIN_DIR', dirname(__FILE__) . '/assets/plugins' );
define( 'WP_PLUGIN_URL', 'http://' . $_SERVER['HTTP_HOST'] . '/edwp-workshop/con-duplicator/assets/plugins' );
